...
void main() {
	...
	worldPos.x += horizontalWarp * tDistance / 10.0 * sin(sin(timeDelta / 112.90 + 1.35) * tDistance / 8.66 + 9.71 * sin(timeDelta / 9.13 + 1.82) + 2.91) * (0.5 + sin(timeDelta / 10.73 + 1.09) / 2.0);
	worldPos.y += verticalWarp * tDistance / 10.0 * sin(sin(timeDelta / 99.29 + 0.23) * tDistance / 11.50 + 8.38 * sin(timeDelta / 10.50 + 0.20) + 1.37) * (0.5 + sin(timeDelta / 10.41 + 0.65) / 2.0);
	worldPos.z += horizontalWarp * tDistance / 10.0 * sin(sin(timeDelta / 112.84 + 3.13) * tDistance / 9.12 + 8.61 * sin(timeDelta / 9.82 + 1.15) + 0.68) * (0.5 + sin(timeDelta / 9.58 + 0.99) / 2.0);
